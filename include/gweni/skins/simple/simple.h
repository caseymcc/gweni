...
public:
    ...
    void drawArrowDown(size_t *primitiveIds, gweni::Rect rect) {};
    void drawArrowUp(size_t *primitiveIds, gweni::Rect rect){};
    void drawArrowLeft(size_t *primitiveIds, gweni::Rect rect){};
    void drawArrowRight(size_t *primitiveIds, gweni::Rect rect){};
    void drawCheck(size_t *primitiveIds, gweni::Rect rect){};
...
//        if(selected)
//        {
//            getRenderer()->setDrawColor(Color(0, 150, 255, 100));
//            getRenderer()->drawFilledRect(gweni::Rect(17, 0, labelWidth+2, labelHeight-1));
//            getRenderer()->setDrawColor(Color(0, 150, 255, 200));
//            getRenderer()->drawLinedRect(gweni::Rect(17, 0, labelWidth+2, labelHeight-1));
//        }
//
