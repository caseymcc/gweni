...
#include <gweni/PlatformTypes.h>
#include <gweni/WindowProvider.h>
...
void OpenGL::freeFont(const gweni::Font& font)
{
...
void OpenGL::freeTexture(const gweni::Texture& texture)
{
...
bool OpenGL::ensureTexture(const gweni::Texture& texture)
{
...
void OpenGL::drawFilledRect(gweni::Rect rect)
{
    if (m_textures_on)
    {
        Flush();
...
void OpenGL::setDrawColor(gweni::Color color)
{
...
void OpenGL::drawTexturedRect(const gweni::Texture& texture, gweni::Rect rect,
...
gweni::Color OpenGL::pixelColor(const gweni::Texture& texture, unsigned int x, unsigned int y,
...
void OpenGL::renderText(const gweni::Font& font, gweni::Point pos,
...
gweni::Point OpenGL::measureText(const gweni::Font& font, const gweni::String& text)
{
    if (!ensureFont(font))
...
bool OpenGL::initializeContext(gweni::WindowProvider* window)
{
...
bool OpenGL::shutdownContext(gweni::WindowProvider* window)
{
#if CREATE_NATIVE_CONTEXT
...
bool OpenGL::presentContext(gweni::WindowProvider* window)
{
#if CREATE_NATIVE_CONTEXT
    HWND hwnd = (HWND)window->getWindow();
...
bool OpenGL::resizedContext(gweni::WindowProvider* window, int w, int h)
{
#if CREATE_NATIVE_CONTEXT
    RECT r;
...
bool OpenGL::beginContext(gweni::WindowProvider* window)
{
...
bool OpenGL::endContext(gweni::WindowProvider* window)
{
    return true;
}
