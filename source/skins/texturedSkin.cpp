...
//    gweni::renderer::Base *render=getRender();
...
{
    IndexMap::iterator iter=m_textureEntryIndex.find(name);
...
void TexturedSkin::loadTextureMap(const json::Value &jsonMap)
{
    ...
    for(const json::Value &jsonEntry:jsonMap.GetArray())
    {
        ...
        if(margin.empty())
        {
            m_textureEntries.emplace_back(name, {boundingBox[0], boundingBox[1], boundingBox[2], boundingBox[3]});
        }
        else
        {
...
void TexturedSkin::loadConfig(std::string configFileName)
{
    ...
    if(jsonDoc.HasMember("colors"))
        loadColors(jsonDoc["color"]);

    if(jsonDoc.HasMember("textureFileName"))
    {
        std::string fileName=rapidjson::getValue<std::string>(jsonColor, "textureFileName");
        imglib::SimpleImage texture;

        imglib::load(texture, fileName);
    }
...
//    {
//        Textures.Input.Button.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(disabled)
//            return Textures.Input.Button.Disabled.draw(getRender(), control, control->getRenderBounds());
//
//        if(depressed)
//            return Textures.Input.Button.Pressed.draw(getRender(), control, control->getRenderBounds());
//
//        if(hovered)
//            return Textures.Input.Button.Hovered.draw(getRender(), control, control->getRenderBounds());
//
//        Textures.Input.Button.Normal.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Input.Button.Normal.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Menu.Check.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
...
//            Textures.Menu.Hover.draw(getRender(), control, rect);
//
//        if(checked)
//            Textures.Menu.Check.draw(getRender(), control, gweni::Rect(rect.x + 4, rect.y + 3, 15, 15));
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Menu.Check.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Menu.Strip.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        Textures.Menu.Strip.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Menu.Strip.remove(getRender(), control);
//    }
//}
//
...
//        if(!paddingDisabled)
//        {
//            return Textures.Menu.BackgroundWithMargin.draw(getRender(), control, control->getRenderBounds());
//        }
//
//        Textures.Menu.Background.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Menu.Strip.remove(getRender(), control);
...
//    if(state == State::Generate)
//    {
//        Textures.Menu.RightArrow.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        Textures.Menu.RightArrow.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Menu.RightArrow.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Shadow.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        const gweni::Rect r=control->getRenderBounds() + Rect(-4, -4, 10, 10);
//        Textures.Shadow.draw(getRender(), control, r);
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Shadow.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.RadioButton.Active.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(selected)
...
//                Textures.RadioButton.Disabled.Checked.draw(getRender(), control, control->getRenderBounds());
//            else
//                Textures.RadioButton.Active.Checked.draw(getRender(), control, control->getRenderBounds());
//        }
//        else
//        {
//            if(control->isDisabled())
//                Textures.RadioButton.Disabled.Normal.draw(getRender(), control, control->getRenderBounds());
//            else
//                Textures.RadioButton.Active.Normal.draw(getRender(), control, control->getRenderBounds());
//        }
//    }
//    else if(state == State::Remove)
//    {
//        Textures.RadioButton.Active.Normal.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.CheckBox.Active.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(selected)
//        {
//            if(control->isDisabled())
//                Textures.CheckBox.Disabled.Checked.draw(getRender(), control, control->getRenderBounds());
//            else
//                Textures.CheckBox.Active.Checked.draw(getRender(), control, control->getRenderBounds());
//        }
//        else
//        {
//            if(control->isDisabled())
//                Textures.CheckBox.Disabled.Normal.draw(getRender(), control, control->getRenderBounds());
//            else
//                Textures.CheckBox.Active.Normal.draw(getRender(), control, control->getRenderBounds());
//        }
//    }
//    else if(state == State::Remove)
//    {
//        Textures.CheckBox.Active.Normal.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.GroupBox.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
...
//        rect.y+=textHeight/2;
//        rect.h-=textHeight/2;
//        Textures.GroupBox.draw(getRender(), control, rect, gweni::colors::White, ~(1<<1));
...
//    else if(state == State::Remove)
//    {
//        Textures.GroupBox.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.TextBox.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(control->isDisabled())
//            return Textures.TextBox.Disabled.draw(getRender(), control, control->getRenderBounds());
//
//        if(control->isFocussed())
//            Textures.TextBox.Focus.draw(getRender(), control, control->getRenderBounds());
//        else
//            Textures.TextBox.Normal.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.TextBox.Normal.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Tab.Right.Active.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(dir == Position::Bottom)
//            Textures.Tab.Bottom.Active.draw(getRender(), control, control->getRenderBounds() + Rect(0, -8, 0, 8));
//        else if(dir == Position::Top)
//            Textures.Tab.Top.Active.draw(getRender(), control, control->getRenderBounds() + Rect(0, 0, 0, 8));
//        else if(dir == Position::Left)
//            Textures.Tab.Left.Active.draw(getRender(), control, control->getRenderBounds() + Rect(0, 0, 8, 0));
//        else if(dir == Position::Right)
//            Textures.Tab.Right.Active.draw(getRender(), control, control->getRenderBounds() + Rect(-8, 0, 8, 0));
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Tab.Right.Active.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Tab.Right.Inactive.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(active)
...
//
//        if(dir == Position::Bottom)
//            Textures.Tab.Bottom.Inactive.draw(getRender(), control, control->getRenderBounds());
//        else if(dir == Position::Top)
//            Textures.Tab.Top.Inactive.draw(getRender(), control, control->getRenderBounds());
//        else if(dir == Position::Left)
//            Textures.Tab.Left.Inactive.draw(getRender(), control, control->getRenderBounds());
//        else if(dir == Position::Right)
//            Textures.Tab.Right.Inactive.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Tab.Right.Inactive.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Tab.Control.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        Textures.Tab.Control.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Tab.Control.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Tab.HeaderBar.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        Textures.Tab.HeaderBar.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Tab.HeaderBar.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Panel.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        Textures.Panel.Normal.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Panel.Normal.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Window.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(inFocus)
//            Textures.Window.Normal.draw(getRender(), control, control->getRenderBounds());
//        else
//            Textures.Window.Inactive.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Window.Normal.remove(getRender(), control);
//    }
//}
//
...
//    {
//        gweni::Rect rect=control->getRenderBounds();
//        getRender()->setDrawColor(gweni::Color(255, 100, 255, 255));
...
//    if(state == State::Generate)
//    {
//        Textures.Scroller.TrackH.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(isHorizontal)
//            Textures.Scroller.TrackH.draw(getRender(), control, control->getRenderBounds());
//        else
//            Textures.Scroller.TrackV.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Scroller.TrackH.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        return Textures.Scroller.ButtonV_Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(!isHorizontal)
//        {
//            if(control->isDisabled())
//                return Textures.Scroller.ButtonV_Disabled.draw(getRender(), control, control->getRenderBounds());
//
//            if(depressed)
//                return Textures.Scroller.ButtonV_Down.draw(getRender(), control, control->getRenderBounds());
//
//            if(isHovered)
//                return Textures.Scroller.ButtonV_Hover.draw(getRender(), control, control->getRenderBounds());
//
//            return Textures.Scroller.ButtonV_Normal.draw(getRender(), control, control->getRenderBounds());
//        }
//
//        if(control->isDisabled())
//            return Textures.Scroller.ButtonH_Disabled.draw(getRender(), control, control->getRenderBounds());
//
//        if(depressed)
//            return Textures.Scroller.ButtonH_Down.draw(getRender(), control, control->getRenderBounds());
//
//        if(isHovered)
//            return Textures.Scroller.ButtonH_Hover.draw(getRender(), control, control->getRenderBounds());
//
//        return Textures.Scroller.ButtonH_Normal.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        return Textures.Scroller.ButtonV_Normal.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.ProgressBar.Front.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        gweni::Rect rect=control->getRenderBounds();
...
//        if(isHorizontal)
//        {
//            Textures.ProgressBar.Back.draw(getRender(), control, rect);
//            rect.w*=progress;
//
//            if(rect.w > 0)
//                Textures.ProgressBar.Front.draw(getRender(), control, rect);
//        }
//        else
//        {
//            Textures.ProgressBar.Back.draw(getRender(), control, rect);
...
//    else if(state == State::Remove)
//    {
//        Textures.ProgressBar.Front.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Input.ListBox.Background.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        return Textures.Input.ListBox.Background.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Input.ListBox.Background.remove(getRender(), control);
//    }
//}
//
...
//    if(state == State::Generate)
//    {
//        Textures.Input.ListBox.EvenLine.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(selected)
//        {
//            if(even)
//                return Textures.Input.ListBox.EvenLineSelected.draw(getRender(), control, control->getRenderBounds());
//            else
//                return Textures.Input.ListBox.OddLineSelected.draw(getRender(), control, control->getRenderBounds());
//        }
//
//        if(control->isHovered())
//            return Textures.Input.ListBox.Hovered.draw(getRender(), control, control->getRenderBounds());
//
//        if(even)
//            return Textures.Input.ListBox.EvenLine.draw(getRender(), control, control->getRenderBounds());
//
//        return Textures.Input.ListBox.OddLine.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Input.ListBox.EvenLine.remove(getRender(), control);
//    }
//}
//
...
//        {
//            getRender()->drawFilledRect(primitiveIds[i], gweni::Rect(rect.x + spacing * i, rect.y + dist - 2, 1, 5));
//        }
//    }
//    else if(state == State::Remove)
//    {
...
//        for(int i=0; i < numNotches + 1; ++i)
//        {
//            getRender()->drawFilledRect(primitiveIds[i], gweni::Rect(rect.x + dist - 1, rect.y + spacing * i, 5, 1));
//        }
//    }
//    else if(state == State::Remove)
//    {
...
//            rect.y+=rect.h/2 - 1;
//            rect.h=1;
//            getRender()->setDrawColor(gweni::Color(0, 0, 0, 100));
//            drawSliderNotchesH(control, state, rect, numNotches, barSize/2);
//            return getRender()->drawFilledRect(primitiveIds[numNotches], rect);
//        }
//
//        gweni::Rect rect=control->getRenderBounds();
//        rect.y+=barSize/2;
...
//    if(state == State::Generate)
//    {
//        Textures.Input.ComboBox.Normal.generate(getRender(), control);
//    }
//    else if(state == State::Update)
//    {
//        if(control->isDisabled())
//            return Textures.Input.ComboBox.Disabled.draw(getRender(), control, control->getRenderBounds());
//
//        if(down || menuOpen)
//            return Textures.Input.ComboBox.Down.draw(getRender(), control, control->getRenderBounds());
//
//        if(control->isHovered())
//            return Textures.Input.ComboBox.Hover.draw(getRender(), control, control->getRenderBounds());
//
//        Textures.Input.ComboBox.Normal.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//        Textures.Input.ComboBox.Normal.remove(getRender(), control);
//    }
//}
//
...
//            if(!skip)
//            {
//                getRender()->drawPixel(&primitiveIds[index++], rect.x + (i * 2), rect.y);
//                getRender()->drawPixel(&primitiveIds[index++], rect.x + (i * 2), rect.y + rect.h - 1);
//            }
//            else
//            {
//                skip=!skip;
...
//            if(!skip)
//            {
//                getRender()->drawPixel(&primitiveIds[index++], rect.x, rect.y + i * 2);
//                getRender()->drawPixel(&primitiveIds[index++], rect.x + rect.w - 1, rect.y + i * 2);
//            }
//            else
//            {
//                skip=!skip;
...
//    else if(state == State::Update)
//    {
//        return Textures.Tooltip.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//
//        if(disabled)
//            return Textures.Scroller.Button.Disabled[i].draw(getRender(), control, control->getRenderBounds());
//
//        if(depressed)
//            return Textures.Scroller.Button.Down[i].draw(getRender(), control, control->getRenderBounds());
//
//        if(hovered)
//            return Textures.Scroller.Button.Hover[i].draw(getRender(), control, control->getRenderBounds());
//
//        return Textures.Scroller.Button.Normal[i].draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//    {
//        if(disabled)
//            return Textures.Input.ComboBox.Button.Disabled.draw(getRender(), control, control->getRenderBounds());
//
//        if(down || menuOpen)
//            return Textures.Input.ComboBox.Button.Down.draw(getRender(), control, control->getRenderBounds());
//
//        if(hovered)
//            return Textures.Input.ComboBox.Button.Hover.draw(getRender(), control, control->getRenderBounds());
//
//        Textures.Input.ComboBox.Button.Normal.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//        {
//            if(control->isDisabled())
//                return Textures.Input.UpDown.Up.Disabled.drawCenter(getRender(), control, control->getRenderBounds());
//
//            if(depressed)
//                return Textures.Input.UpDown.Up.Down.drawCenter(getRender(), control, control->getRenderBounds());
//
//            if(control->isHovered())
//                return Textures.Input.UpDown.Up.Hover.drawCenter(getRender(), control, control->getRenderBounds());
//
//            return Textures.Input.UpDown.Up.Normal.drawCenter(getRender(), control, control->getRenderBounds());
//        }
//
//        if(control->isDisabled())
//            return Textures.Input.UpDown.Down.Disabled.drawCenter(getRender(), control, control->getRenderBounds());
//
//        if(depressed)
//            return Textures.Input.UpDown.Down.Down.drawCenter(getRender(), control, control->getRenderBounds());
//
//        if(control->isHovered())
//            return Textures.Input.UpDown.Down.Hover.drawCenter(getRender(), control, control->getRenderBounds());
//
//        return Textures.Input.UpDown.Down.Normal.drawCenter(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//    else if(state == State::Update)
//    {
//        Textures.StatusBar.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//
//        if(open)
//            Textures.Tree.Minus.draw(getRender(), control, rect);
//        else
//            Textures.Tree.Plus.draw(getRender(), control, rect);
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//    else if(state == State::Update)
//    {
//        Textures.Tree.Background.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//
//        if(disabled)
//            return Textures.Window.Close.draw(getRender(), control, r, gweni::Color(255, 255, 255, 50));
//
//        if(depressed)
//            return Textures.Window.Close_Down.draw(getRender(), control, r);
//
//        if(hovered)
//            return Textures.Window.Close_Hover.draw(getRender(), control, r);
//
//        Textures.Window.Close.draw(getRender(), control, r);
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//        {
//            if(disabled)
//                return Textures.Window.Maxi.draw(getRender(), control, r, gweni::Color(255, 255, 255, 50));
//
//            if(depressed)
//                return Textures.Window.Maxi_Down.draw(getRender(), control, r);
//
//            if(hovered)
//                return Textures.Window.Maxi_Hover.draw(getRender(), control, r);
//
//            return Textures.Window.Maxi.draw(getRender(), control, r);
//        }
//
//        if(disabled)
//            return Textures.Window.Restore.draw(getRender(), control, r, gweni::Color(255, 255, 255, 50));
//
//        if(depressed)
//            return Textures.Window.Restore_Down.draw(getRender(), control, r);
//
//        if(hovered)
//            return Textures.Window.Restore_Hover.draw(getRender(), control, r);
//
//        return Textures.Window.Restore.draw(getRender(), control, r);
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//
//        if(disabled)
//            return Textures.Window.Mini.draw(getRender(), control, r, gweni::Color(255, 255, 255, 100));
//
//        if(depressed)
//            return Textures.Window.Mini_Down.draw(getRender(), control, r);
//
//        if(hovered)
//            return Textures.Window.Mini_Hover.draw(getRender(), control, r);
//
//        Textures.Window.Mini.draw(getRender(), control, r);
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//        {
//            if(control->isDisabled())
//                return Textures.Input.Slider.V.Disabled.drawCenter(getRender(), control, control->getRenderBounds());
//
//            if(depressed)
//                return Textures.Input.Slider.V.Down.drawCenter(getRender(), control, control->getRenderBounds());
//
//            if(control->isHovered())
//                return Textures.Input.Slider.V.Hover.drawCenter(getRender(), control, control->getRenderBounds());
//
//            return Textures.Input.Slider.V.Normal.drawCenter(getRender(), control, control->getRenderBounds());
//        }
//
//        if(control->isDisabled())
//            return Textures.Input.Slider.H.Disabled.drawCenter(getRender(), control, control->getRenderBounds());
//
//        if(depressed)
//            return Textures.Input.Slider.H.Down.drawCenter(getRender(), control, control->getRenderBounds());
//
//        if(control->isHovered())
//            return Textures.Input.Slider.H.Hover.drawCenter(getRender(), control, control->getRenderBounds());
//
//        Textures.Input.Slider.H.Normal.drawCenter(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//        if(selected)
//        {
//            Textures.Selection.draw(getRender(), control, gweni::Rect(17, 0, labelWidth+2, labelHeight-1));
//        }
//    }
//    else if(state == State::Remove)
//    {
...
//    else if(state == State::Update)
//    {
//        Textures.CategoryList.Outer.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
...
//    {
//        if(collapsed)
//            return Textures.CategoryList.Header.draw(getRender(), control, control->getRenderBounds());
//
//        Textures.CategoryList.Inner.draw(getRender(), control, control->getRenderBounds());
//    }
//    else if(state == State::Remove)
//    {
//    }
