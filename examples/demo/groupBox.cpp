...
GroupBoxDemo::GroupBoxDemo(controls::Base *parent, const String &name):
    Base(parent)
{
    controls::GroupBox *group=new controls::GroupBox(this);

    group->setText("Group Box");
    group->setSize(300, 200);

    controls::Label *label=new controls::Label(group);
